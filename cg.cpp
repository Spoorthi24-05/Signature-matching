...
void front()
{
	...
	output(250,650,"BASAVESHWAR ENGINEERING COLLEGE BAGALKOT",fonts[2]);
	glColor3f(1.0,1.0,0.0);
	output(300,600,"DEPARTMENT OF COMPUTER SCIENCE",fonts[2]);
	//glColor3f(0.8,0.1,0.2); red
	glColor3f(1.0,1.0,1.0);
	output(300,500,"GRAPHICAL IMPLEMENTATION OF AIRSHOW",fonts[2]);
	glColor3f(0.8,0.1,0.2);
	output(450,400,"SUBMITTED BY :",fonts[2]);
	glColor3f(0.3,0.5,0.8);
	output(250,350,"1] Apoorva Gadagin",fonts[2]);
	output(650,350,"3] Aishwarya PatilHiremath",fonts[2]);
	output(450,350,"2] Apeksha Hatti",fonts[2]);
